 ...
 import PlanesearchPlane from "../carhire/CarComponent/PlaneSearchBarPlace";
 ...
 const FightSearchBarLargeHomeScreens = () => {
 ...
 export default FightSearchBarLargeHomeScreens
