    ...
    <div className='w-full  max-w-screen-xl flex flex-col space-y-7 py-8 items-center justify-center  '>
       ...
       <div className="w-full grid grid-cols-1 md:grid-cols-2  lg:grid-cols-3 gap-8">
        ...
        <Link href={`${fromcountry}-${tocounry}/departlocation/${data}`}  key={index} className="hover:cursor-pointer h-32 sm:h-80 b  shadow-sm hover:shadow-lg  duration-500   flex sm:flex-col  white items-center justify-center w-full border rounded-md   ">
           ...
           {/* Image */}
           <Image height={350} width={350} src={`/${data}.jpeg`}  className="h-full sm:max-h-[65%] rounded-l-md sm:rounded-bl-none sm:rounded-t-md object-cover w-full max-w-[30%] sm:max-w-full " alt="bbbb" />
