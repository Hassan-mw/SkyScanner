...
function planeFilterFlight() {
    ...
    return (
        <div className="grid grid-cols-3  w-full h-20  px-2 ">
          {/* By Best */}
          <div  onClick={()=>setCurrentOption("Best")} className={`flex flex-col pl-5 border rounded-l-md text-slate-500 ${currentOption==="Best" ?'bg-slate-800 text-white' :'bg-white '} p-2`}>
          ...
          {/* By Fastest */}
          <div  onClick={()=>setCurrentOption("Fast")} className={`flex flex-col pl-5  border rounded-r-md text-slate-500 ${currentOption==="Fast" ?'bg-slate-800 text-white' :'bg-white '} p-2`}>
