...
const ShowCurrentPageHotel = () => {
  return (
    ...
    <div className="flex flex-col sm:flex-row items-start justify-between w-full space-y-5 sm:space-y-0 sm:space-x-8 font-base  text-slate-900">
        ...
        <span className={`${jost.className} text-sm `}>Find the best-value hotel for your dates, search by price or preferences</span>
        </div>
        ...
        <span className={`${jost.className} text-sm `}>Look out for hotels with free cancellation or excellent ratings</span>
        </div>
