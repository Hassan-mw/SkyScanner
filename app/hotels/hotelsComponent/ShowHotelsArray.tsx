...
function ShowHotelsArray({country,text}) {
  ...
  return (
        ...
        {/* IMAGE */}
         <div className="w-full bg-blue-500 max-h-60 sm:w-[40%]  overflow-hidden rounded-t-md sm:rounded-none sm:rounded-l-2xl">
        ...
        {/* CONTENT */}
         ...
         <div className="flex flex-col w-full items-start justify-center  md:justify-start md:pt-6 p-2 md:px-7 space-y-2 md:border-r  border-slate-300  ">
          ...
          <span style={{fontWeight:300}} className={`${jost.className}  text-sm text-slate-500`}>12.10 km from city centre</span>
            <div  className="flex items-center justify-start gap-x-1 ">
                     <div  className="flex items-end justify-end  ">
                        ...
                        <span style={{fontWeight:200}} className={`${jost.className} pt-1  text-[12px] text-slate-400`}>124 review</span>
                     </div>
      ...
      <div className=" bg-white hidden md:block"><img className="w-16 " src="/d_ct.png"/></div>
        ...
        <span className="text-xl font-semibold ">Rs 15,517</span>
