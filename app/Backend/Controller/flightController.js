...
exports.getAllFlight=async(req,res,next)=>{
 ...
 try{
  ...
  WHERE fromcountry=$1 AND tocountry=$2 AND departdate=$3 AND returndate=$4 AND person=$5 AND type=$6 `,[startPlace,endPlace,startDate,endDate,totaltraveller,roomType])
